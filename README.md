...
| Локация | Среднее RPS | Максимальное RPS |
| --- | --- | --- |
| Орегон | 830 | 2.5K |
| Вирджиния | 830 | 2.5K |
| Франкфурт | 970 | 2.9K|
...
BGP Anycast для маршрутизации трафика в ближайший доступный датацентр внутри страны (подсети), а также для использования дополнительных датацентров (CDN).
...
| API-Gateway | 21.7K | легкая | 5 | 50 Mb | 1191.76 |
| L4 балансировщики | 21.7K | SSL handshake (CPS) | 44 | 440 Mb | 1191.76 |
| Envoy | 21.7K | SSL handshake (CPS) | 44 | 440 Mb | 1191.76 |
| Cassandra | 28.5K | легкая | 6 | 60 Mb | 0.114 |
| Kafka | 27.3K | легкая | 6 | 60 Mb | 0.0437 |
...
| СУБД | Общий размер данных | Размер данных с учетом репликации (3х) |
| --- | --- | --- |
| Cassandra | 140.67 TB | 422.01 TB |
| Redis | 123.2 GB | 369.6 GB |
| Tarantool | 540 GB | 1.62 TB |
| Kafka | 16.83 TB | - |
| ElasticSearch | 653.23 GB | 1.96 TB |
| AWS S3 | 7 PB | - |
...
| Сервис | CPU | RAM | Storage | Трафик, Gb/s |
| --- | --- | --- | --- | --- |
| Kubernetes | 1038 | 200 GB | - | 2210 |
| L4 балансировщики | 44 | 440 Mb | - | 1191.76 |
| Envoy | 44 | 440 Mb | - | 1191.76 |
| Cassandra | 6 | 60 Mb | 422.01 TB | 0.114 |
| Redis | 2 | 369.6 GB | - | 0.0036 |
| Tarantool | 6 | 1.62 TB | - | 0.0086 |
| Kafka | 6 | 60 Mb | 16.83 TB | 0.0437 |
| ElasticSearch | 1 | 10 Mb | 1.96 TB | 0.001 |
| AWS S3 | - | - | 7 PB | 3.2 |


### Обеспечение отказоустойчивости

Выделим следующие подсети DNS:
- Америка: 3 дата-центра (Орегон, Вирджиния, Сан-Паулу)

| Дата-центр | Пиковая нагрузка, RPS | Пиковая нагрузка при падении другого ДЦ в подсети, RPS | Увеличение  пиковой нагрузки при падении другого ДЦ в подсети, % |
| --- | --- | --- | --- |
| Орегон | 2.5K | 4.15K | 66 |
| Вирджиния | 2.5K | 4.15K | 66 |
| Сан-Паулу | 3.3K | 4.15K | 26 |

- Европа, Азия и Африка: 5 дата-центров (Франкфурт, Лондон, Токио, Сингапур, Дубай)

| Дата-центр | Пиковая нагрузка, RPS | Пиковая нагрузка при падении другого ДЦ в подсети, RPS | Увеличение  пиковой нагрузки при падении другого ДЦ в подсети, % |
| --- | --- | --- | --- |
| Франкфурт | 2.9K | 3.2K | 10 |
| Лондон | 2.9K | 3.2K | 10 |
| Токио | 2.9K | 3.2K | 10 |
| Сингапур | 3K | 3.2K | 7 |
| Дубай | 1K | 3.2K | 220 |

В среднем, каждый дата-центр должен выдерживать нагрузку на 52% больше, чем при обычной нагрузке, для обеспечения отказоустойчивости в случае падения одного из дата-центров в подсети DNS. 

### Расчет ресурсов с учетом отказоустойчивости

Таким образом, итоговый расчет ресурсов будет выглядеть следующим образом:

| Сервис | CPU | RAM | Storage | Трафик, Gb/s |
| --- | --- | --- | --- | --- |
| Kubernetes | 1557 | 300 GB | - | 3315 |
| L4 балансировщики | 66 | 660 Mb | - | 1786.5 |
| Envoy | 66 | 60 Mb | - | 1786.5 |
| Cassandra | 9 | 90 Mb | 422.01 TB | 0.171 |
| Redis | 2 | 369.6 GB | - | 0.0054 |
| Tarantool | 9 | 1.62 TB | - | 0.0129 |
| Kafka | 9 | 90 Mb | 16.83 TB | 0.0655 |
| ElasticSearch | 2 | 20 Mb | 1.96 TB | 0.0015 |
| AWS S3 | - | - | 7 PB | 3.2 |
...
| Сервис | CPU | RAM | Storage | Трафик, Gb/s | Хостинг | Конфигурация | Количество |
| --- | --- | --- | --- | --- | --- | --- | --- |
| Kubernetes | 1557 | 300 GB | - | 3315 | own | Intel Xeon Silver 4314 16 Cores/8GB RAM/1xSSD240GB/2x25Gb/s | 96 |
| Kubernetes | 1557 | 300 GB | - | 3315 | AWS | m6i.2xlarge (8vCPU/32GB RAM/12.5Gb/s) | 266 |
...
| Сервис | CPU | RAM | Storage | Трафик, Gb/s | Хостинг | Конфигурация | Количество |
| --- | --- | --- | --- | --- | --- | --- | --- |
| Envoy | 66 | 60 Mb | - | 1786.5 | own | Intel Xeon Silver 4314 16 Cores/8GB RAM/1xSSD240GB/2x25Gb/s | 36 |
| Envoy | 66 | 60 Mb | - | 1786.5 | AWS | m6i.2xlarge (8vCPU/32GB RAM/12.5Gb/s) | 143 |
| Cassandra | 9 | 90 Mb | 422.01 TB | 0.171 | own | Intel Xeon Silver 4314 16 Cores/8GB RAM/1xSSD4TB/1x25Gb/s | 106 |
| Cassandra | 9 | 90 Mb | 422.01 TB | 0.171 | AWS | i3en.3xlarge (12vCPU/96GB RAM/1xSSD7.5TB/12.5Gb/s) | 57 |
| Redis | 2 | 369.6 GB | - | 0.0054 | own | Intel Xeon Silver 4314 16 Cores/2x128GB RAM/1xSSD240GB/2x25Gb/s | 2 |
| Redis | 2 | 369.6 GB | - | 0.0054 | AWS | r6id.4xlarge (16vCPU/128 GB RAM/1xSSD1TB/12.5Gb/s) | 3 |
| Tarantool | 9 | 1.62 TB | - | 0.0129 | own | Intel Xeon Silver 4314 16 Cores/2x128GB RAM/1xSSD240GB/2x25Gb/s | 7 |
| Tarantool | 9 | 1.62 TB | - | 0.0129 | AWS | r6id.4xlarge (16vCPU/128 GB RAM/1xSSD1TB/12.5Gb/s) | 13 |
| Kafka | 9 | 90 Mb | 16.83 TB | 0.0655 | own | Intel Xeon Silver 4314 16 Cores/8GB RAM/1xSSD4TB/1x25Gb/s | 5 |
| Kafka | 9 | 90 Mb | 16.83 TB | 0.0655 | AWS | i3en.3xlarge (12vCPU/96GB RAM/1xSSD7.5TB/12.5Gb/s) | 3 |
| ElasticSearch | 2 | 20 Mb | 1.96 TB | 0.0015 | own | Intel Xeon Silver 4314 16 Cores/8GB RAM/1xSSD4TB/1x25Gb/s | 1 |
| ElasticSearch | 2 | 20 Mb | 1.96 TB | 0.0015 | AWS | i3en.3xlarge (12vCPU/96GB RAM/1xSSD7.5TB/12.5Gb/s) | 1 |

### Количество серверов
- собственный дата-центр

| Конфигурация | Предназначение | Количество | Цена |
| --- | --- | --- | --- |
| Intel Xeon Silver 4314 16 Cores/8GB RAM/1xSSD240GB/2x25Gb/s | stateless | 132 | $5000[^13] |
| Intel Xeon Silver 4314 16 Cores/8GB RAM/1xSSD4TB/1x25Gb/s | on-disk database | 112 | $6000[^13] |
| Intel Xeon Silver 4314 16 Cores/2x128GB RAM/1xSSD240GB/2x25Gb/s | in-memory database | 9 | $6300[^13] |
| **Итого** |  |  | **$1,386,000** |

- AWS

| Конфигурация | Предназначение | Количество | Аренда за час |
| --- | --- | --- | --- |
| m6i.2xlarge (8vCPU/32GB RAM/12.5Gb/s) | stateless | 409 | $0.384[^14] |
| i3en.3xlarge (12vCPU/96GB RAM/1xSSD7.5TB/12.5Gb/s) | on-disk database | 61 | $1.356[^14] |
| r6id.4xlarge (16vCPU/128 GB RAM/1xSSD1TB/12.5Gb/s) | in-memory database | 16 | $1.2096[^14] |
| **Итого** |  |  | **$259.1256** |

### Сравнение цен
При хостинге в собственном дата-центре с учетом амортизации на 5 лет (по 20% в год) и резерва на расширение сервиса (+40%) получим: \$1,386,000 + \$1,386,000 \* 0.2 \* 5 + \$1,386,000 \* 0.4 = **\$3,326,400**

При хостинге в облачном сервисе (AWS) в течение 5 лет с учетом резерва на расширение сервиса (+40%) получим: \$259.1256 \* 24 \* 365 \* 5 \* 1.4 = **\$15,889,582**

**Вывод:** выгоднее хостить в собственном дата-центре
...
[^13]: https://www.broadberry.com/dual-xeon-scalable-gen3-rackmount-servers/cyberserve-sp1g3-424
[^14]: https://aws.amazon.com/ru/ec2/pricing/on-demand/
