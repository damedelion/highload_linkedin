...
| **Итог** |  | **34.7K** | **104K** |  | **540.80 GB/s** | **1622.41 GB/s** |
...
BGP Anycast для маршрутизации трафика в ближайший доступный датацентр внутри страны при помощи дополнительных датацентров.
